...
public class VpnProfileDetailActivity extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTncNotice.setOnClickListener(v -> new TncNoticeDialog().show(VpnProfileDetailActivity.this.getSupportFragmentManager(), "TncNotice"));
		...
		mSelectApps.setOnClickListener(v -> {
